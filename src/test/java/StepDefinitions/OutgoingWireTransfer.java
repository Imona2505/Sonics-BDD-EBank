...
public class OutgoingWireTransfer {
    ...
    public void user_transfers_money()throws InterruptedException {
        ...
        outgoingWireTransfer.outgoingWireTransfer("SMCOGB2L", "Adam", "123 Bronx Ave", "Bronx", "New York","nited States of America", "AL35202111090000000001234567", "Test","1000", "USD");
    }
